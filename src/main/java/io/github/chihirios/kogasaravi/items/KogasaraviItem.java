...
public class KogasaraviItem {
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(Kogasaravi.MODID);

    public static final DeferredItem<BlockItem> KOGASABLOCK_ITEM = ITEMS.registerSimpleBlockItem("exmapleblock", KogasaraviBlocks.KOGASABLOCK);
